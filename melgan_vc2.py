...
def build_mapping_network(latent_dimen,num_domains,style_dimen):
  ...
  g4=ReLU()(g3)
  g5=Dense(512,kernel_initializer=init)(g4)
  g6=ReLU()(g5)
  g7=Dense(512,kernel_initializer=init)(g6)
  g8=ReLU()(g7)

  x=[]
  for i in range(num_domains):
    g9=Dense(512,kernel_initializer=init)(g8)
    g10=ReLU()(g9)
    g11=Dense(512,kernel_initializer=init)(g10)
    g12=ReLU()(g11)
    g13=Dense(512,kernel_initializer=init)(g12)
    g14=ReLU()(g13)
...
def train_all(a,b,i,j,refs=None,trgs=None):
  ...
  with tf.GradientTape() as tape_gen, tf.GradientTape() as tape_disc:
    ...
    lossgtot = loss_g+10.*loss_m+0.5*loss_id+sty_loss+ds_loss                                       #CHANGE LOSS WEIGHTS HERE  (COMMENT OUT +w*loss_id IF THE IDENTITY LOSS TERM IS NOT NEEDED)
